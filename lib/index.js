...
module.exports = function Request_Handler (req, res) {
        if (!req.headers["user-agent"].startsWith("Betterpinger - https://npmjs.com/packages/betterpinger")) return res.end("This page is not intended to be displayed in a normal browser.");
        res.write(``);
